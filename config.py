...
parser.add_argument('--smoothing', type=float, default=0.999)   # smoothing factor for smoothed generator.
...
parser.add_argument('--max_resl', type=int, default=6)          # 10-->1024, 9-->512, 8-->256
...
parser.add_argument('--flag_norm_latent', type=bool, default=True) # pixelwise normalization of latent vector (z)
...
parser.add_argument('--display_tb_every', type=int, default=100)      # display progress every specified iteration.
